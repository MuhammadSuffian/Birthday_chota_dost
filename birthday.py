...
def get_premium_birthday_wishes():
    return [
        "May this extraordinary day be just the beginning of a year filled with beautiful memories, wonderful discoveries, and all the success you deserve.",
        "On this special celebration of your life, I hope that every moment brings you happiness that's as beautiful and unique as you are.",
        "As you celebrate another year of your amazing journey, may your path forward be lined with moments of joy, love, and extraordinary achievements.",
        "Your birthday marks another year of you gracing the world with your wonderful presence. May your celebration be as magnificent as the light you bring into our lives.",
        "As the calendar marks this special day, may it bring you endless reasons to smile, dream, and embrace the beautiful gift of being you.",
        "Like a rare gem, you shine with incomparable brilliance. May your birthday reflect the extraordinary light you bring to everyone around you.",
        "Today we celebrate the day the world received its most precious gift. May your birthday bring you everything your heart desires and more.",
        "May this birthday usher in a year of fulfilled wishes, realized dreams, and unexpected joys that make every day a celebration."
    ]
...
def get_personal_memories():
    return [
        ...
        "Your smile always brightens even the darkest days.",
